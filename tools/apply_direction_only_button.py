...
exec(Path('tools/apply_step64_controls.py').read_text(encoding='utf-8'), {})
exec(Path('tools/apply_step65_torneko_item_footstep.py').read_text(encoding='utf-8'), {})
exec(Path('tools/apply_step66_dungeon_visual_depth.py').read_text(encoding='utf-8'), {})
exec(Path('tools/apply_step67_adopted_full_screen.py').read_text(encoding='utf-8'), {})
